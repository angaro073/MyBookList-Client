      ...
      <ul>
        <li>
          <p>
            ...
            downloaded by You on any electronic device, named MyBookList
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to MyBookList.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to MyBookList, accessible from
            <a href="https://www.mybooklist.com" rel="external nofollow noopener" target="_blank"
              >https://www.mybooklist.com</a
            >
          </p>
        </li>
        <li>
